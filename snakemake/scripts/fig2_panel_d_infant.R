...
if (length(args) != 7) {
    cat('neuron and oligo muts should be VAF-BASED! no rescue!\n')
    stop('usage: fig2_panel_d_infants.R neuron_muts.csv oligo_muts.csv cosmic.csv out.pdf out.svg out.spectra.csv out.exposures.csv')
}
