...
inputFile     = ['output' filesep '21_WGS_BRCA' filesep 'full' filesep 'res_21_breast_WGS_substitutions_full_signatures_4.mat']; % Identified file with optimal number of mutational signatures
...
if ( length(unexplainedIDs) > 10 ) % do not examine datasets with less than 10 samples
    ...
    tic
        outputFolder = ['output' filesep '21_WGS_BRCA' filesep 'L2'];
